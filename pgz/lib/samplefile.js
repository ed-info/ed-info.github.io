// Sample file for IndexedDB filesystem
(async function initializeFileSystem() {
  const F = new FileSystem('epythonfs');
  
  // Створюємо теки
  await F.mkdir('textFiles');
  await F.mkdir('images');

  // Тепер можна безпечно записувати файли
  await F.write('textFiles/Pumpkin.txt',
    '\n' +
    'Гарбузова родина\n' +
    '-----------------------------\n' +
    '\n' +
  ...
  await F.write('images/Snake.png',
    'data:image/jpeg;base64,iVBORw0KGgoAAAANSUhEUgAAADAAAAAwCAMAAABg3Am1AAADAFBMVEVHcEwrzzK60uUA1QAAzwAA1gAA0gAAzgC60eS50OQAxQC6/+EAygC60eS00d1l5mW20t+\
     ...
     ogywhM5gbwsRFH5iksXY3v5oyE7B6kQgIcFgkre63fzHffaBdGrB8hVhaigMRc+x8b+CpKvilQAKQf65DuDHDHHtnJn87vBNtuIUSWZpNuo/V2M3ZOYqBz/D7AOLHnSFViMx1JOdAREAqqqeqB1z8YmK\
  ...
  console.log('Файлову систему успішно ініціалізовано.');
})();
