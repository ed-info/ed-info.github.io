                ...
                html_uk    = [
                    '<div class="ace_search right">',
                        ...
                        '<div class="ace_search_form">',
                            '<input class="ace_search_field" placeholder="Шукати" spellcheck="false"></input>',
                            '<button type="button" action="findNext" class="ace_searchbtn next"></button>',
                            '<button type="button" action="findPrev" class="ace_searchbtn prev"></button>',
                            '<button type="button" action="findAll" class="ace_searchbtn" title="Alt-Enter">Всі</button>',
                        '</div>',
                        '<div class="ace_replace_form">',
                            '<input class="ace_search_field" placeholder="Замінити на" spellcheck="false"></input>',
                            '<button type="button" action="replaceAndFindNext" class="ace_replacebtn">Замінити </button>',
                            '<button type="button" action="replaceAll" class="ace_replacebtn"> Всі</button>',
                        '</div>',
                        '<div class="ace_search_options">',
                            '<span action="toggleRegexpMode" class="ace_button" title="Пошук RegExp">.*</span>',
                            '<span action="toggleCaseSensitive" class="ace_button" title="Врахувати регістр">Aa</span>',
                            '<span action="toggleWholeWords" class="ace_button" title="Цілі слова">\\b</span>',
                        '</div>',
                    '</div>'
                ].join('');
                var html,
