CodeMirror.defineSimpleMode("pseudocode", {
    start: [
      ...
      {regex: /функція|результат|якщо|поки|інакше|цикл|для|не|від|то|вивести|ввести|кін|до|точка|лінія|прямокутник|трикутник|коло|еліпс|фон|колір|чотирикутник|заповнення/, token: "keyword"},
