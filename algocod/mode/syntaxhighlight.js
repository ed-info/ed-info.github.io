CodeMirror.defineSimpleMode("pseudocode", {
    start: [
      ...
      {regex: /функція|вершина|дуга|ламана|фігура|контур|товщина|анімація|результат|якщо|поки|інакше|цикл|для|не|від|то|вивести|ввести|кін|безанімації|до|точка|лінія|прямокутник|трикутник|коло|еліпс|фон|колір|чотирикутник|заповнення/, token: "keyword"},
