...
*/
   ...
   */    
    for (index = l = 0, len2 = buttons.length; l < len2; index = ++l) {
      ...
      if (text === "New folder") { 
		   buttons[index]="<button style='width:143px;height:32px;font-size:12' onclick='newFolder()'"+"><i class='fa fa-folder' ></i> New Folder</button>"
		  };
      if (text === "Get file") { 
		   buttons[index]="<button style='width:133px;height:32px;font-size:12' onclick='document.getElementById("+ String.fromCharCode(34)+'getfile'+ String.fromCharCode(34)+").click()'"+"><i class='fa fa-file-o' ></i> Add File</button><input type='file' id='getfile' onchange='readFile(this)' style='display:none'>"
		  };
