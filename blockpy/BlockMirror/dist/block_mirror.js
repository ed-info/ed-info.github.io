...
BlockMirror.prototype.validateConfiguration = function (configuration) {
  ...
  this.configuration.height = configuration.height || 550; // viewMode
...
BlockMirrorBlockEditor.prototype.TOOLBOXES = {
  ...
  }, TOOLBOX_CATEGORY.SEP, '<category name="Вирази" expanded="true">', {
    name: "Константи",
    colour: "TEXT",
  ...
  }, TOOLBOX_CATEGORY.INPUT, '</category>', TOOLBOX_CATEGORY.SEP, '<category name="Операції" expanded="true">', {
    name: "Присвоювання",
    colour: "VARIABLES",
    blocks: ["VARIABLE = ___", "___.append(___)"]
  }, TOOLBOX_CATEGORY.OUTPUT_WITH_PLOTTING, '</category>', TOOLBOX_CATEGORY.SEP, '<category name="Контроль" expanded="true">', {
    name: "Керування",
    colour: "CONTROL",
    blocks: ['if ___: pass', 'if ___: pass\nelse: pass']
  }, {
